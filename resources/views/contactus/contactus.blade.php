            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/admin/contactmessages" class="d-flex flex-column flex-sm-row gap-3 mb-3" method="GET">
                                ...
                                @forelse ($contactmessages->reverse() as $index => $contactmessage)
                                    <tr>
                                        ...
                                        <td class="d-flex gap-2">
                                            {{-- <a href="/admin/contactmessages/{{$contactmessages->id}}" target="_blank" class="btn btn-primary text-white">View</a> --}}
                                            ...
                                            <form action="/admin/contactmessages/{{$contactmessage->id}}/delete" method="post" onsubmit="return confirm('Are you sure you want to delete?');">
                                                @csrf
                                                @method('DELETE')
