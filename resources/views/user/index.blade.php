            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="" class="d-flex flex-column flex-sm-row gap-3 mb-3" method="GET">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#userModal{{ $user->id }}">
                                                    <img 
                                                        src="{{ asset($user->image ? "https://solarecombackend.minthantoo.com/storage/$user->image" : "https://picsum.photos/1000/680?random=" . $user->id) }}"
                                                        alt=""
                                                    >           
                                                </a>   
                                            </td>
